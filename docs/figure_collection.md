...
$$
⇒ \begin{cases}
    (i ω) \left[ \left(1 + \frac{F}{b_1} f\right) T_1 + \frac{F}{b_1} (1-f) T_2 \right] &= ikc_1 \left( 1 - α_{1, 1} \right) T_1 - ikc_2 α_{1, 2} T_2\\

    (iω) T_2 &= -i k c_1 α_{2, 1} T_1 + ikc_2 (1-α_{2, 2}) T_2 - γ_q q \\

    (iω) \left[ \frac{F}{b_1} f m_1 T_1 + \frac{F}{b_1} (1-f)m_1 T_2 + q \right] &= -m_2 γ_q q
\end{cases}
$$
...
\end{pmatrix} = \underbrace{\begin{pmatrix}
    ikc_1 (1-α_{1, 1}) & -ikc_2 \alpha_{1, 2} & 0\\
    -ikc_1 α_{2, 1} & ikc_2 (1-α_{2, 2}) & -γ_q \\
    0 & 0 & -m_2 γ_q
...
$$
   ⇒ iω𝐌 \; \vec{v} = 𝐋 \; \vec{v} ⇒ \left( iω𝐌 - 𝐋 \right)\;\vec{v} = \vec{0}
$$
...
where $ℳ_{23}$ and $ℳ_{33}$ are the corresponding $2 × 2$ minors.
